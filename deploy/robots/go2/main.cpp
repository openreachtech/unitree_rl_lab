...
int main(int argc, char** argv)
{
    ...
    std::cout << "Remote: [L2+A] FixStand, [Start] Velocity, [L2+Up] Dynamic, [L2+Right] Multitask, [L2+B] Passive\n";
    std::cout << "Keyboard: [1] FixStand, [Enter] Velocity, [2] Dynamic, [6] Multitask, [0] Passive\n";
    ...
    std::cout << "Multitask: one policy for both. Drive with [F/B/L/R/Y/U] and fire\n";
    std::cout << "           [3] jump, [4] backflip, [5] sideflip *while moving*.\n";
