#!/usr/bin/env bash
# Loop 40 (v37 継続) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 40 (v37 継続) start: continue from model_28600, no change, from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 40 (v37 継続) exited with code $? ==="
