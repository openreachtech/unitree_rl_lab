#!/usr/bin/env bash
# Loop 43 (v40) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 43 (v40) start: foot_clearance 7.4->16 (the uncapped height axis), from model_27200, +1500 iters ==="
python scripts/rsl_rl/train.py --task Unitree-Go2-LongJump-v1 --headless --num_envs 4096 \
  --max_iterations 1500 --resume --load_run 2026-09-10_00-52-05 --checkpoint model_28600.pt \
  --deploy-keyboard-commands
echo "=== [$(ts)] Loop 43 (v40) exited with code $? ==="
