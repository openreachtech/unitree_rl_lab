#!/usr/bin/env bash
# Loop 37 (v35) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 37 (v35) start: apex weight 27->50 (raise the height budget), from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 37 (v35) exited with code $? ==="
