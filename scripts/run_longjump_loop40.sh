#!/usr/bin/env bash
# Loop 41 (v38) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 41 (v38) start: track_lin_vel_xy 0.8->1.2 (hold approach near 3.5), from model_27200, +1500 iters ==="
python scripts/rsl_rl/train.py --task Unitree-Go2-LongJump-v1 --headless --num_envs 4096 \
  --max_iterations 1500 --resume --load_run 2026-09-10_01-22-47 --checkpoint model_30000.pt \
  --deploy-keyboard-commands
echo "=== [$(ts)] Loop 41 (v38) exited with code $? ==="
