#!/usr/bin/env bash
# Loop 42 (v39) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 42 (v39) start: entropy_coef 0.002->0.005 (restore exploration), from model_27200, +1500 iters ==="
python scripts/rsl_rl/train.py --task Unitree-Go2-LongJump-v1 --headless --num_envs 4096 \
  --max_iterations 1500 --resume --load_run 2026-09-10_01-52-42 --checkpoint model_30500.pt \
  --deploy-keyboard-commands
echo "=== [$(ts)] Loop 42 (v39) exited with code $? ==="
