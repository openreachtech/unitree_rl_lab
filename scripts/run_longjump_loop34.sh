#!/usr/bin/env bash
# Loop 35 (v33) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 35 (v33) start: approach pinned 3.2 + leg_contact -5.0, from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 35 (v33) exited with code $? ==="
