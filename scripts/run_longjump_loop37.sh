#!/usr/bin/env bash
# Loop 38 (v36) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 38 (v36) start: entropy_coef -> 0.002 (stop the diffusion), from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 38 (v36) exited with code $? ==="
