#!/usr/bin/env bash
# Loop 39 (v37) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 39 (v37) start: track_lin_vel_xy 1.5->0.8 (reduce the competition), from model_27200, +1500 iters ==="
python scripts/rsl_rl/train.py --task Unitree-Go2-LongJump-v1 --headless --num_envs 4096 \
  --max_iterations 1500 --resume --load_run 2026-09-09_19-56-37 --checkpoint model_27200.pt \
  --deploy-keyboard-commands
echo "=== [$(ts)] Loop 39 (v37) exited with code $? ==="
