#!/usr/bin/env bash
# Loop 44 (v41) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 44 (v41) start: foot_clearance 16->10 (midpoint), from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 44 (v41) exited with code $? ==="
