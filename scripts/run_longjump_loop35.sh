#!/usr/bin/env bash
# Loop 36 (v34) -- penalise knees/elbows touching down. From Loop 32's model_27200.
#
...
echo "=== [$(ts)] Loop 36 (v34) start: apex target 0.37->0.40 (unsaturate), from model_27200, +1500 iters ==="
...
echo "=== [$(ts)] Loop 36 (v34) exited with code $? ==="
