...
def _register_perceptive_actor_critic(train_cfg: dict) -> None:
    policy_cfg = train_cfg.get("policy", {})
    if policy_cfg.get("class_name") != "ActorCriticPerceptiveRecurrent":
        return
    ...
    on_policy_runner_module.ActorCriticPerceptiveRecurrent = ActorCriticPerceptiveRecurrent
...
class UnitreeOnPolicyRunner(OnPolicyRunner):
    ...
    def __init__(self, env, train_cfg, log_dir=None, device="cpu"):
        ...
        _register_perceptive_actor_critic(train_cfg)
